...
export function AddProductForm() {
    ...
    return (
        <form>
            <label htmlFor="hibernateProduct-name">Product name</label>
            <input id="hibernateProduct-name" ref={productNameRef} type="text"/>

            <label htmlFor="hibernateProduct-price">Product price</label>
            <input id="hibernateProduct-price" ref={productPriceRef} type="number"/>
